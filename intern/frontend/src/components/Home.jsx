...
const Home = (props) => {
  ...
  return (
    <div>
        <header>          
            <Navbar text={'e-Shopping'} button1={'Home'} button2={'About'} button3={'Contact us'} button4={'Help?'} button1Path={'#home'} button2Path={'#about'} button3Path={'#contactus'} button4Path={'#help'}  fullWidth/><br /><br /><br />
        </header>
        <body>  
